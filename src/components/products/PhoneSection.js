...
import { Card, CardContent, CardMedia, Typography, Button, Container, Box, IconButton, Snackbar, Alert, Skeleton, Chip, Fade, Grow } from '@mui/material';
...
const PhoneSection = ({ products, loading, error, darkMode, onAddToCart }) => {
  ...
  const loadWishlist = async () => {
    try {
      ...
      console.log("Loaded wishlist product IDs in PhoneSection:", wishlistProductIds);
