...
const SmartTvSection = ({ products, loading, error, darkMode, onAddToCart }) => {
  ...
  const loadWishlist = async () => {
    try {
      ...
      console.log("Loaded wishlist product IDs in SmartTvSection:", wishlistProductIds);
              ...
              <Box 
                ...
                >
                  <CardMedia
                    component="img"
                    alt={product.name}
                      image={getFrontImageUrl(product) || product.imageUrl || "/placeholder.jpg"}
                    sx={{ 
                      maxWidth: '100%',
                      maxHeight: '100%',
                      objectFit: 'contain'
