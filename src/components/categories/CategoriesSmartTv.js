...
const CategoriesSmartTv = ({ products, loading, error, darkMode }) => {
      ...
      <Container maxWidth="xl" sx={{ pt: 3, pb: 6 }}>
        {loading ? (
          ...
          <Box sx={{ 
            ...
            <TvIcon sx={{ fontSize: 64, color: darkMode ? '#aaa' : '#666', mb: 2 }} />
          ...
          <>
            <Box sx={{ 
              ...
              <TvIcon sx={{ mr: 2, fontSize: 32, color: '#6039f0' }} />
              <Typography 
                variant="h4" 
                component="h1" 
                sx={{ 
                ...
                >
                  <Box>
                    ...
                    >
                      ...
                      {/* Low stock indicator - показывать, когда осталось 5 или меньше товаров */}
