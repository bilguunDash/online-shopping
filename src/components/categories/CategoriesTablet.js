...
const CategoriesTablet = ({ products, loading, error, darkMode }) => {
      ...
      <Container maxWidth="xl" sx={{ pt: 3, pb: 6 }}>
        {loading ? (
          ...
          <Box sx={{ 
            ...
            <TabletMacIcon sx={{ fontSize: 64, color: darkMode ? '#aaa' : '#666', mb: 2 }} />
          ...
          <>
            <Box sx={{ 
              ...
              <TabletMacIcon sx={{ mr: 2, fontSize: 32, color: '#6039f0' }} />
              <Typography 
                variant="h4" 
                component="h1" 
                sx={{ 
