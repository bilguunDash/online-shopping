    ...
    const teamMembers = [
        {
            ...
            bio: 'With over 15 years in retail technology, Sarah leads our company vision and strategy.',
            avatar: '/images/team/sarah.jpg'
        },
        {
            name: 'David Chen',
            role: 'Chief Technology Officer',
            bio: 'David brings 12 years of experience building scalable e-commerce platforms.',
            avatar: '/images/team/david.jpg'
        },
        {
            name: 'Maria Rodriguez',
            role: 'Head of Customer Experience',
            bio: 'Maria ensures our customers have the best shopping experience possible.',
            avatar: '/images/team/maria.jpg'
        },
        {
            name: 'James Wilson',
            role: 'Supply Chain Director',
            bio: 'James oversees our global supply network and inventory management.',
            avatar: '/images/team/james.jpg'
        }
    ];

    const milestones = [
        { year: '2018', event: 'Company founded with a focus on consumer electronics' },
        { year: '2019', event: 'Launched our first online store with 200 products' },
        { year: '2020', event: 'Expanded to mobile devices and accessories' },
        { year: '2021', event: 'Reached 10,000 customers and opened first physical store' },
        { year: '2022', event: 'Added international shipping to 15 countries' },
        { year: '2023', event: 'Launched our mobile app and loyalty program' },
        { year: '2024', event: 'Expanding to laptops and smart home technology' }
    ];

    const values = [
        {
            title: 'Quality Products',
            description: 'We curate only the best tech products that meet our rigorous standards for performance and reliability.',
            icon: <CheckCircleOutlineIcon sx={{ fontSize: 40, color: '#1e4620' }} />
        },
        {
            title: 'Customer Satisfaction',
            description: 'Your happiness is our priority. We work tirelessly to ensure every interaction exceeds expectations.',
            icon: <SupportAgentIcon sx={{ fontSize: 40, color: '#1e4620' }} />
        },
        {
            title: 'Fast Delivery',
            description: 'We partner with premium logistics providers to ensure your products arrive quickly and safely.',
            icon: <LocalShippingIcon sx={{ fontSize: 40, color: '#1e4620' }} />
        },
        {
            title: 'Secure Shopping',
            description: 'Your data security is paramount. We employ bank-level encryption to protect every transaction.',
                    ...
                    <Grid container spacing={4} justifyContent="center">
                        ...
                        <Grid item xs={12} md={6}>
                            <Box sx={{ textAlign: 'left', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                                <Typography variant="h4" sx={{ mb: 3, fontWeight: 700 }}>Our Story</Typography>
                                <Typography
                                    variant="body1"
                                    sx={{
                                        mb: 2,
