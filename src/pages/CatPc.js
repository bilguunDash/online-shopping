    ...
    import PcSection from "../components/categories/CategoriesPc";
    ...
    const CatPc = ({ darkMode, toggleDarkMode }) => {
        ...
        const fetchFilterOptions = async () => {
            try {
                const response = await api.get("/product/filter/options", {
                    params: { categoryId: 6 } // PC category ID
                });
        ...
        const fetchFilteredProducts = async () => {
            ...
            try {
                ...
                const params = {
                    categoryId: 6, // Explicitly include categoryId
                };
                ...
                console.log("PC fetching with params:", params);
                ...
                try {
                    ...
                    console.log("PC filter response status:", response.status);
                    console.log("PC filter response data type:", typeof response.data);
                    console.log("PC filter response data length:", Array.isArray(response.data) ? response.data.length : "not an array");
                    
                    // If no products from filter endpoint, try direct category fetch
                    if (!response.data || (Array.isArray(response.data) && response.data.length === 0)) {
                        console.log("No PC products from filter API, trying direct category endpoint");
                        const directResponse = await api.get("/product/pc");
                        
                        if (directResponse.data && Array.isArray(directResponse.data) && directResponse.data.length > 0) {
                            console.log(`Found ${directResponse.data.length} PC products from direct API`);
                            setProducts(directResponse.data);
                            setLoading(false);
                            return;
                        }
                    }
                    ...
                    if (Array.isArray(response.data)) {
                        ...
                        console.log(`Final unique PC products count: ${uniqueProducts.length}`);
                        setProducts(uniqueProducts);
                    } else {
                        console.log("PC response data is not an array, using as is");
                    ...
                    const fallbackResponse = await api.get("/product/category/4");
                            ...
                            <Container maxWidth="xl" sx={{ mb: 4, pt: 2 }}>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            Тоглоом, ажил, бүтээлч үйл ажиллагаанд зориулсан өндөр гүйцэтгэлтэй суурин компьютеруудыг танилцуулж байна
                                        </Typography>
                                    </Box>
                                </Box>
                            </Container>
                        ...
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs={12} sm={6} md={2}>
                                <FormControl fullWidth size="small">
                                    ...
                                    >
                                        <MenuItem value="">Дурын өнгө</MenuItem>
                            ...
                            <Grid item xs={12} sm={6} md={2}>
                                <FormControl fullWidth size="small">
                                    <InputLabel>Санах ой (GB)</InputLabel>
                                    <Select
                                        name="storageGb"
                                    ...
                                    >
                                        <MenuItem value="">Дурын санах ой</MenuItem>
                            ...
                            <Grid item xs={12} sm={6} md={2}>
                                <FormControl fullWidth size="small">
                                    ...
                                    >
                                        <MenuItem value="">Дурын RAM</MenuItem>
                            ...
                            <Grid item xs={12} sm={6} md={2}>
                                <FormControl fullWidth size="small">
                                    ...
                                    >
                                        <MenuItem value="">Дурын дэлгэц</MenuItem>
                            ...
                            <Grid item xs={12} sm={6} md={2}>
                                <FormControl fullWidth size="small">
                                    <InputLabel>Видео карт</InputLabel>
                                    <Select
                                        name="graphics"
                                    ...
                                    >
                                        <MenuItem value="">Дурын видео карт</MenuItem>
                            ...
                            <Grid item xs={12} sm={6} md={2}>
                                <FormControl fullWidth size="small">
                                    ...
                                    >
                                        <MenuItem value="">Дурын процессор</MenuItem>
