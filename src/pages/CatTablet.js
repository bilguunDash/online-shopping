...
import TabletSection from "../components/categories/CategoriesTablet";
...
const CatTablet = ({ darkMode, toggleDarkMode }) => {
    ...
    const [filters, setFilters] = useState({
        categoryId: 7, // Tablet category ID
        color: '',
        storageGb: '',
        ramGb: '',
        display: '',
    ...
    const fetchFilterOptions = async () => {
        try {
            const response = await api.get("/product/filter/options", {
                params: { categoryId: 7 } // Tablet category ID
            });
    ...
    const fetchFilteredProducts = async () => {
        ...
        try {
            ...
            try {
                ...
                const fallbackResponse = await api.get("/product/category/3");
                        ...
                        <Container maxWidth="xl" sx={{ mb: 4, pt: 2 }}>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        Хамгийн шилдэг таблетуудыг нэг дороос
                                    </Typography>
                                </Box>
                            </Box>
                        </Container>
